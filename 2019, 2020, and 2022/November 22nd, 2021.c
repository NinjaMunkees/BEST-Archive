...
task Autonomous()	//Autonomous program
{
	...
	motor[RMotor] = 127;
	wait1Msec(((7500 - nImmediateBatteryLevel) * 0.12 + 540) * 3); // Takes median battery level and scales our movement based on input
	motor[LMotor] = 127;	//Right turn
	motor[RMotor] = -127;
	wait1Msec((7500 - nImmediateBatteryLevel) * 0.16 + 540);
	motor[LMotor] = 80;	//Forward
	motor[RMotor] = 127;
	wait1Msec(((7500 - nImmediateBatteryLevel) * 0.12 + 540) * 4);
	motor[LMotor] = 0;	//Stop
	motor[RMotor] = 0;
}
