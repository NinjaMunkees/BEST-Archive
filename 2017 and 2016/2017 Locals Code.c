...
task Shoot()
{
	while(true)
	{
		if(vexRT[Btn6U] == true)//While the top right button on the back of the controller is pressed down, the shooter runs in 1/3 second increments, always ending at the same position
		{
			motor[Shooter] = 127;
		}
		wait1Msec(333);
